        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                to="/signup"
                className="gradient-bg text-white px-6 py-2 rounded-full hover:shadow-lg transition"
              >
                Get Started
              </Link>
            </div>
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 justify-center">
              <Link
                to="/signup"
                className="gradient-bg text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition inline-flex items-center gap-2"
              >
                Start Free Trial
              ...
              <Link
                to="/login"
                className="bg-white border border-gray-300 text-gray-700 px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition"
              >
                Sign In
              </Link>
            </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Bank-level security to protect your financial data and privacy</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="bg-blue-500 w-12 h-12 rounded-full mb-4"></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="bg-green-500 w-12 h-12 rounded-full mb-4"></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="bg-purple-500 w-12 h-12 rounded-full mb-4"></div>
