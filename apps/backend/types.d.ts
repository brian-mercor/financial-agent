...
declare module 'motia' {
  ...
  interface Handlers {
    'WorkflowWSRelay': EventHandler<unknown, never>
    'WorkflowTriggerHandler': EventHandler<{ workflowId: string; userId: string; message: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string }; agents: string[] }, { topic: 'workflow.started'; data: never } | { topic: 'workflow.agent.started'; data: never }>
    ...
    'WorkflowOrchestrator': ApiRouteHandler<{ message: string; userId: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: 'conservative' | 'moderate' | 'aggressive' } }, unknown, { topic: 'workflow.started'; data: never } | { topic: 'workflow.agent.started'; data: never } | { topic: 'workflow.agent.completed'; data: never } | { topic: 'workflow.completed'; data: never }>
    ...
    'ChatStream': ApiRouteHandler<{ message: string; assistantType?: 'general' | 'analyst' | 'trader' | 'advisor' | 'riskManager' | 'economist'; userId?: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string }; history?: { id: string; role: 'user' | 'assistant'; content: string; timestamp: string; assistantType?: string; chartHtml?: string; hasChart?: boolean; isStreaming?: boolean }[]; stream?: boolean; responseStyle?: 'conversational' | 'report' }, unknown, { topic: 'workflow.trigger'; data: { workflowId: string; userId: string; message: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string }; agents: string[] } } | { topic: 'chart.requested'; data: unknown }>
    ...
    'AgentExecutor': EventHandler<{ workflowId: string; stepIndex: number; agent: string; task: string }, { topic: 'workflow.agent.completed'; data: never } | { topic: 'workflow.agent.progress'; data: never } | { topic: 'workflow.completed'; data: never } | { topic: 'workflow.agent.started'; data: never }>
  }
}